...
if(isset($_POST['search']))
{
    ...
    $query = "SELECT * FROM `inventario` WHERE `Activo`=1 and CONCAT(`IdInventario`, `Articulo`, `Descripcion`, `Marca`, `Costo`, `Precio`, `Cantidad`, `IdProovedor`,`IdSucursal`) LIKE '%".$valueToSearch."%'";
...
<html lang="en">
    <head>
        ...
        ?>
		<body id="body-pd">
        <span class="nav__name"><h1>INVENTARIO / BUSCAR</h1></span>
      
        
        <br><br>
<form action="inventario_buscar.php" method="post">
	...
	<table style= "border: 2px solid black">
		<tr style= "background-color: black;" class="infotabla">
            ...
            <td colspan="2">Acción</td>
                ...
                <tr>
                    ...
                    <td><a href="inventario_editar.php?IdInventario=<?php echo $row['IdInventario']; ?>"  class="btn__update" >Editar</a></td>
                </tr>
                <?php endwhile;?>
            </table>
        </form>
		...
		<br><br>
	<a href="pdf_inventario.php" target="_blank">
