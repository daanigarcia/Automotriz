...
if(isset($_POST['search']))
{
    ...
    $query = "SELECT * FROM `empleado` WHERE CONCAT(`IdEmpleado`, `Nombre`, `Fecha_Nacimiento`, `Estado_Civil`, `CURP`, `Telefono_1`, `Telefono_2`, `Correo`, `Domicilio`, `Codigo_Postal`,`Puesto`,`Sueldo`, `IdSucursal`) LIKE '%".$valueToSearch."%'";
...
<html lang="en">
    <head>
        ...
        ?>
		<body id="body-pd">
       <span class="nav__name"><h1>EMPLEADOS / DESACTIVAR</h1></span>
      
        
        <br><br>
<form action="empleados_desactivar.php" method="post">
		...
		<tr style= "background-color: black;" class="infotabla">
			...
			<td width="150px">Desactivar</td>
                ...
                <tr>
                    ...
                    <td><a name="Guardar" href="empleados_desactivar_accion.php?IdEmpleado=<?php echo $row['IdEmpleado']; ?>"  class="btn__update" >Desactivar</a></td>
